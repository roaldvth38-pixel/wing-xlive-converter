...
PLUGIN_TARGET="Dolby740_VST3"
PLUGIN_BUNDLE_NAME="Dolby 740.vst3"
INSTALL_BUNDLE_NAME=""
PACKAGE_NAME="Dolby740_VST3"
PKG_ID="com.audioplugincreator.dolby740.vst3"
...
usage() {
  cat <<'EOF'
Package Dolby 740 VST3 as a macOS installer (.pkg).

Usage:
  ./package_dolby740_vst3_mac_installer.sh [options]
...
Options:
  ...
  --plugin-target <target>           CMake VST3 target (default: Dolby740_VST3)
  --plugin-bundle-name <name.vst3>   Source bundle folder name from build output (default: Dolby 740.vst3)
  --install-bundle-name <name.vst3>  Bundle folder name written into installer (default: source bundle name)
  --package-name <name>              Package file prefix (default: Dolby740_VST3)
  --pkg-id <identifier>              pkgbuild identifier (default: com.audioplugincreator.dolby740.vst3)
